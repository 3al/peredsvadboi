<?php
// $Id: page.tpl.php,v 1.3 2011/01/06 03:58:38 pixture Exp $
  ...
  <div id="page" style="<?php echo $page_style; ?>">
    ...
    <div class="section clearfix">
      ...
      <?php endif; ?>
             ...
             <div id="header-searchbox" style="<?php echo $searchbox_style; ?>"><?php print render($page['googlesearch']); ?></div>
    ...
    <?php if ($main_menu || $secondary_menu) { ?>
      <div id="navigation"><div class="section">
		...
		<!-- trial: выводим главное меню только на главной, чтобы не снижать CTR на посадочных страницах -->
		<?php if($is_front): ?>
...
<script type="text/javascript" charset="utf-8">
	...
	position: 'right',
        hostcommunity:'http://peredsvadboi.copiny.com',
        newwindow: '0',
        type: 'question',
	color: 	  '#613eaa',
        border:   '#ffffff',
	...
	title:	  "\u0417\u0430\u0434\u0430\u0439\u0442\u0435 \u0432\u043e\u043f\u0440\u043e\u0441!",
        cache:   "b5467294055f9f41b6080be35556180d\/b5467294055f9f41b6080be35556180d\/ejOwVXUxULU0B5FOBmDSBIltqepiqGphBGabaoMpCMcVTLqBpQ1gIkC2oaqRIQA-",
        community:5139
};
